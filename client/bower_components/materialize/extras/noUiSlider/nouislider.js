...
(function () {
	function r(b) {
		...
		}s(e, "mark", "thousand");s(e, "prefix", "negative");s(e, "prefix", "negativeBefore");return e;
	}function u(b, f, c) {
		var d,
		    e = [];for (d = 0; d < h.length; d += 1) {
			e.push(b[h[d]]);
		}e.push(c);return f.apply("", e);
	}function t(b) {
		if (!(this instanceof t)) return new t(b);"object" === (typeof b === "undefined" ? "undefined" : _typeof(b)) && (b = x(b), this.to = function (f) {
			return u(b, v, f);
